...
class SinFFT:
    ...
    def create_sin(self):
        ...
        self.datasin = np.sign(self.time)
    ...
    def _caculate_frequencies(self,data):
    ...
    def plot_spectrum(self):
        plt.subplot(313)
        magDb = self._caculate_frequencies(self.data)
        minDb = min(magDb)
        maxDb = max(magDb)
        ...
        plt.plot(frequency, magDb[0:self.nfft / 2 - 1], color = 'k')
